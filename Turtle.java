...
public static void main(String[] a) {
    ...
    // ตัว
    bob.backward(50);
    bob.dot("white", 160); // ตัว

    bob.forward(110);
    bob.dot("white", 110); // หัว
    ...
    bob.penColor("white");
    bob.width(18);
    bob.up(); bob.forward(10); bob.down(); bob.forward(5); // ลายขีด 1
    bob.up(); bob.forward(10); bob.down(); bob.forward(5); // ลายขีด 2
    bob.up();



    bob.home(); bob.left(90); bob.forward(100);
    ...
    // หน้าตา
    bob.home(); bob.left(90); bob.forward(70);
    ...
    // ปาก
    bob.home(); bob.left(90); bob.forward(42);
    bob.left(90); bob.forward(20);
    bob.left(120);
    ...
    // แขน
    bob.home(); bob.left(90); bob.backward(10);
    ...
    //กระดุม
    bob.home(); bob.left(90); bob.backward(30);
    bob.dot("orange", 12);
    bob.backward(28); bob.dot("orange", 12);
    bob.backward(28); bob.dot("orange", 12);
}
